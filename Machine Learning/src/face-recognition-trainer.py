...
PROCESSED_IMAGE_PATH = './datasets/prc-faces'
PROCESSED_CSV_FILE = './datasets/prc-faces.csv'
DETECTED_FACE_PATH = './datasets/crp-faces'
DETECTED_CSV_FILE = './datasets/crp-faces.csv'
OUTPUT_MODEL_NAME = './model-svm/gender-classify-v1.lib'
